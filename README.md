...
- [SE Crash Course 2019](#se-crash-course-2019)
  ...
  - [Session 2: Actual Development](#session-2-actual-development)
    - [Version Control, and its neccessity](#version-control-and-its-neccessity)
  ...
  - [Session 3: Challenges within Software Engineering Process and CI/CD](#session-3-challenges-within-software-engineering-process-and-cicd)
    ...
    - [CI/CD: A case study with Gitlab and Heroku](#cicd-a-case-study-with-gitlab-and-heroku)
    - [Cloud Computing & Containerization](#cloud-computing--containerization)
  - [Session 4: Project showcase, Learning Outcomes and Exposure](#session-4-project-showcase-learning-outcomes-and-exposure)
    - [Presentation & Product Pitching](#presentation--product-pitching)
    - [Sharing](#sharing)
    - [Reminder on Continual Learning](#reminder-on-continual-learning)
...
## Session 2: Actual Development

We will be employing a slightly traditional approach in learning development.

- relates back to architectural design

### Version Control, and its neccessity
...
## Session 3: Challenges within Software Engineering Process and CI/CD
...
## Session 4: Project showcase, Learning Outcomes and Exposure
